            ...
            <div className="container-fluid m-3 p-3">
                <div className="row">
                    ...
                    <div className="col-md-7">
                        ...
                        <div className="m-1">
                            <Select bordered={false} placeholder="select category" size='medium' showSearch className='form-select mb-3' onChange={(value) => { setCategory(value) }}>
                                {categories?.map(c => (
                            ...
                            <div className="mb-3">  
                                {photo && (
                                    <div className="text-center">
                                        <img src={URL.createObjectURL(photo)} alt='product photo' height={'150px'} className='img img-responsive' />
                                    </div>
                                )}
                            </div>
                            <div className="mb-3">
